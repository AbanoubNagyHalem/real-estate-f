...
function Footer() {
  return (
    ...
    >
      <Grid container justifyContent="space-between" alignItems="center" sx={{ px: 3 }}>
      ...
      <Typography variant="body1" align="left" sx={{ px: 15, mb: 5 }}>
        <p className='footer-info'>Specialists in providing high-class tours for <br />those in need Contact us.</p>
      </Typography>

      {/* Grid Section */}
      <Grid container spacing={4} sx={{ px: 3, textAlign: { xs: 'center', md: 'center' } }}>
        <Grid item xs={12} md={4}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', mb: 2, mx: 12 }}>
            ...
            <Typography variant="body2" component="p" className='footer-span'>123 Main St, City, Country</Typography>
          </Box>
          <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 , mx: 12}}>
            <PhoneIcon className='footer-contact' />
            <Typography variant="body2" component="p" className='footer-span'>+20 123 070 1443</Typography>
          </Box>
          <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 , mx: 12 }}>
            <EmailIcon className='footer-contact' />
            <Typography variant="body2" component="p" className='footer-span'>info@company.com</Typography>
          </Box>
        </Grid>
        <Grid item xs={12} md={4}>
          <Typography variant="h6" component="div" sx={{ mb: 2, color: 'var(--Secondary-1)' }}>
      ...
      {/* Copyright Section */}
      <Typography variant="body2" align="center" sx={{ px: 3, color: 'var(--Secondary-2)' }}>
